#description: Installs Datto RMM agent for Stewart & Co client
#tags: Nerdio, Apps install, Datto RMM, Stewart & Co
<#
Notes:
This script downloads and installs the Datto RMM agent for the Stewart & Co client.
The agent installer is downloaded from the Datto RMM portal and executed silently.

Key features:
- Downloads the Datto RMM agent installer from the Stewart & Co-specific URL
...
$DownloadUrl = "https://merlot.rmm.datto.com/download-agent/windows/62dafe1f-19c4-4676-b016-8fa94099696e"
...
Write-Host "Downloading Datto RMM agent installer for Stewart & Co..."
