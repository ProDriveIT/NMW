#description: Enforces MDM enrollment for Cheesman devices (runs after domain join)
#tags: Nerdio, MDM Enrollment, Intune, Entra Hybrid Join
...
.AUTHOR
    ...
    Modified for Cheesman tenant
#>

# Required Tenant ID - Cheesman Tenant
